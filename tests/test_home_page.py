...
class HomePageTest(unittest.TestCase):
    ...
    def test_tools_are_metadata_sorted_with_new_grader_first(self):
        ...
        self.assertEqual("M17", tools[0]["code"])
        self.assertEqual("pages/16_17_grade_workbench.py", tools[0]["page"])
        self.assertEqual("M16", tools[1]["code"])
        self.assertEqual("pages/15_16_report_grader.py", tools[1]["page"])
        self.assertTrue(tools[1]["blocked"])
        self.assertEqual("M15", tools[2]["code"])
        self.assertEqual("pages/15_0_email_notice.py", tools[2]["page"])
        self.assertEqual("M14", tools[3]["code"])
        self.assertTrue(tools[3]["locked"])
        self.assertEqual("M13", tools[4]["code"])
        self.assertEqual("M12", tools[5]["code"])
        self.assertTrue(tools[5]["blocked"])
    ...
    def test_homepage_keeps_blocked_cards_in_metadata_order(self):
        ...
        self.assertEqual("M12", tools[5]["code"])
        self.assertTrue(tools[5]["blocked"])
        self.assertEqual("M08", tools[9]["code"])
        self.assertEqual("M07", tools[10]["code"])
        self.assertEqual("M06", tools[11]["code"])
        self.assertEqual("M05", tools[12]["code"])
        self.assertTrue(tools[12]["blocked"])
        self.assertEqual(["M17", "M16", "M15", "M14", "M13", "M12", "M11", "M10", "M09"], [tool["code"] for tool in homepage_pages[0]])
        self.assertEqual(["M08", "M07", "M06", "M05", "M04", "M03", "M02", "M01"], [tool["code"] for tool in homepage_pages[1]])
