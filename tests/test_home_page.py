...
class HomePageTest(unittest.TestCase):
    ...
    def test_tools_are_module_number_sorted_with_highest_module_first(self):
        ...
        self.assertEqual("M11", tools[6]["code"])
    ...
    def test_homepage_keeps_blocked_cards_in_module_number_order(self):
        ...
        self.assertEqual("M13", tools[5]["code"])
        self.assertEqual("M11", tools[6]["code"])
        self.assertEqual("M10", tools[7]["code"])
        self.assertEqual("M09", tools[8]["code"])
        self.assertEqual("M05", tools[12]["code"])
        self.assertTrue(tools[12]["blocked"])
        self.assertEqual(["M18", "M17", "M16", "M15", "M14", "M13", "M11", "M10", "M09"], [tool["code"] for tool in homepage_pages[0]])
