...
class HomePageTest(unittest.TestCase):
    def test_home_page_uses_command_center_copy_and_pagination(self):
        ...
        self.assertIn("count_tool_status", page_source)
        self.assertIn("build_hero_status_html", page_source)
        self.assertIn("tool_card_classes", page_source)
        self.assertIn("is-blocked", page_source)
        self.assertIn("is-locked", page_source)
        self.assertIn("hero-status", page_source)
        self.assertIn("hero-visual", page_source)
        self.assertIn("meter-value", page_source)
        self.assertIn("is-blocked", theme_source)
        self.assertIn("is-active", theme_source)
        self.assertIn("_workbench_shell_css", theme_source)
        self.assertIn("pagination-item.active", theme_source)
        self.assertIn("min-height: 148px", theme_source)
